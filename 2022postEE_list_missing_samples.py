...
expected_samples_file = f"{year}_samples_list.txt"  # File with expected samples (if manually created)
found_samples_file = f"{year}_samples.txt"  # File to store detected sample names
missing_samples_file = f"{year}_missing_samples.txt"  # File to store missing samples
storage_site_report_file = f"{year}_storage_sites_report.txt"
